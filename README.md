...
```
your-folder/
├── underwrite-iq-lite/    <-- API backend
└── fundhub-website-GHL/   <-- this repo (frontend)
```
...
You need **2 Terminal windows** - one for the API, one for the website.
...
| `fundhub.ai`     | `underwrite-iq-lite.vercel.app` (production)   |
...
| Page                     | Local URL                                       |
| ------------------------ | ----------------------------------------------- |
| Credit Analyzer          | `localhost:8080/credit-analyzer.html`           |
| Fix My Credit Results    | `localhost:8080/fix-my-credit-analyzer.html`    |
| Funding Approved Results | `localhost:8080/funding-approved-analyzer.html` |
| Referral Dashboard       | `localhost:8080/referral-dashboard.html`        |
